import { property, LitElement, customElement, css, html as html$1 } from '../lit-element.js';
...
let WiredHelper = class WiredHelper extends LitElement {
    ...
    render() {
        return html$1 `
            ...
            ${this.debug ? html$1 `<button @click="${() => this.refresh()}">Refresh</button>` : ''}
        `;
    }
    refresh() {
        if (this.debug)
...
class TmProjectList extends LitElement {
  ...
  render() {
    return html$1`
            ...
            <div class="container">
                <h2>${this.heading}</h2>
                ${this.projects.map(project => html$1`<div class="card">
                        <tm-project-card
                        image="${project.image}"
